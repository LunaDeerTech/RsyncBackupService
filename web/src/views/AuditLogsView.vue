...
<template>
	<section class="page-view">
		...
		<section class="page-two-column">
			<AppCard title="筛选器" description="时间范围使用本地时间输入，提交时自动转为 RFC3339。">
			...
			<AppCard title="最近操作时间线" description="从当前筛选结果中抽取最近 8 条，方便快速扫描。">
				<AppTimeline v-if="timelineItems.length > 0" :items="timelineItems" compact />
				<AppEmpty v-else title="没有匹配的审计事件" compact />
			</AppCard>
		</section>
